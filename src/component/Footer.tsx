...
export default function Footer() {
    return (
        <footer className='bg-[#101010] font-federo'>
            <div className='container mx-auto border-white'>
                <div className='grid grid-cols-1 md:grid-cols-3 gap-10 py-[100px]'>
                    <div className='space-y-5'>
                        ...
                        <p className='text-[#ffffffb3] text-[17px] font-barlow'>Dagency architecture miss in the sapien sertiton miss bibenum the erat nesuen fermen.</p>
                ...
                <div className='py-10 border-t border-[#ffffff12]'>
                    <div className=''></div>
                    <p className='font-barlow text-[17px] text-[#ffffffb3]'>© Copyright 2025 Dagency | All Rights Reserved.</p>
                </div>
            </div>
